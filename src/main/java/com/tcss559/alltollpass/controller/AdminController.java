...
public class AdminController {
    ...
    public void deleteUser(UserRequest userRequest) throws DatabaseException, UserNotFoundException {
        adminService.deleteUser(userRequest);
    }

    // Get transactions for a given status
    @GetMapping("/reports/{status}")
    @ResponseStatus(HttpStatus.OK)
    public List<TransactionResponse> getReports(@RequestHeader("status") String status) throws DatabaseException {
    ...
    @ResponseStatus(HttpStatus.OK)
    public UserResponse getUserDetailsByUserName(@RequestHeader("username") String username) throws DatabaseException {
        return adminService.getUserDetailsByUserName(username);
    }
